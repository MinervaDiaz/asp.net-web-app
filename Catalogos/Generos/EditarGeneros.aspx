<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarGeneros.aspx.cs" Inherits="LibrosWeb.Catalogos.Generos.EditarGeneros" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                <asp:Label ID="lblidgenero" runat="server" Text=""></asp:Label>
